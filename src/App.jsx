        ...
        <table className="table">
          ...
          <tbody>
            {searchResult ? (
             ...
             <li><button onClick={() => editData(result.id)} className="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal">Edit</button></li>
               <li><button className="btn btn-info btn-sm" onClick={() => deletedata(result.id)}>Delete</button></li>
                      </ul>
                        </div>
                  </td>
                    </tr>
